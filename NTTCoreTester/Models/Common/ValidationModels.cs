...
namespace NTTCoreTester.Models.Common
{
    ...
    public class ValidationResult
    {
        ...
        public void Merge(ValidationResult other)
        {
            ...
            Level1Errors.AddRange(other.Level1Errors);
            Level2Errors.AddRange(other.Level2Errors);
            Level3Errors.AddRange(other.Level3Errors);
            CorrelationErrors.AddRange(other.CorrelationErrors);
        }
